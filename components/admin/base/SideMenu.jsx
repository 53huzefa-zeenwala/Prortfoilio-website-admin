...
function SideMenuLink({ children, path, displayName }) {
    const { pathname } = useRouter()
    const { setAdminMenu } = useStateContext()
    ...
    return (
        <Link
            ...
            className={`${checkBackgroundAndColor('/admin' + path)} rounded-lg px-4 py-2 hover:bg-teal-200 hover:text-gray-800 `}
        >
...
export default function SideMenu() {
    ...
    return (
        <div style={{ transform: adminMenu ? "translateX(0)" : "translateX(-100%)", boxShadow: "rgb(0 0 0 / 30%) 5px -1px 12px 0px" }} className="flex h-screen flex-col justify-between border-r border-slate-800 bg-slate-900/70 w-64 fixed top-0 left-0 bottom-0 transition-transform duration-500 z-40  backdrop-blur-sm rounded-3xl rounded-l-none overflow-hidden">
            <div className="px-4 py-6">
                <nav aria-label="Main Nav" className="mt-6 flex flex-col space-y-1 mr-2">
                    ...
                    <SideMenuLink path="/addProject" displayName="new project">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 opacity-75"
                            fill="none"
                    ...
                    <SideMenuLink path="/projects" displayName="All Projects">
                    ...
                    <SideMenuLink path="/user" displayName="User details">
                    ...
                    <SideMenuLink path="/socialLink" displayName="Social Link">
                    ...
                    <SideMenuLink path="/services" displayName="Services">
                    ...
                    <SideMenuLink path="/comments" displayName="Comments">
        ...
        M439.058,204.129H195.92v-24.314h243.138V204.129z M439.058,128.143H195.92v-24.315h243.138V128.143z"/>
                    ...
                    <SideMenuLink path="/contacts" displayName="Contacts">
                    ...
                    <SideMenuLink path="/createUser" displayName="Create User">
				...
				c-38,0-72-47.6-74.4-103.6C188.686,120.743,198.686,121.543,208.686,121.543z"/>
                    ...
                    <SideMenuLink path="/assets" displayName="Assets">
