...
export default function HamburgerMenuIcon({setOpen, open}) {
    const menuClick = () => open ? setOpen(false) : setOpen(true)    
    return (
        <>
            <button id={style.menu} onClick={menuClick} className={open ? style.opened : ""} aria-label="Main Menu">
